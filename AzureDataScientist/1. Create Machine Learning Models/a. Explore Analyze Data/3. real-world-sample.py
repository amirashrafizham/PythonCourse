...
def show_density(var_data):
    ...
    plt.axvline(x=var_data.mean(), color='cyan',
...
m, b, r, p, se = stats.linregress(
    df_regression['StudyHours'], df_regression['Grade'])
...
print('Studying for {} hours per week may result in a grade of {:.0f}'.format(
