...
def analyze_bmi(bmi_value):
    if(bmi_value > 30):
        print("Your BMI is in the obese range. To lower your cost, you should signifcantly lower your BMI.")
    elif(bmi_value >= 25 and bmi_value <= 30):
        print("Your BMI is in the overweight range. To lower your cost, you should signifcantly lower your BMI.")
