...
insurance_cost = 250*age - 28*sex+370*bmi + \
...
# Age Factor
age += 4
new_insurance_cost = 250*age - 28*sex+370*bmi + \
    425*num_of_children+24000*smoker-12500
...
print(
    f"The change in cost of insurance after increasing BMI by 3.1 is {change_in_insurance_cost} dollars.")
